          ...
          children:   [
            ...
            // Text('DATER',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Color(0xffFD877B)),),
             ...
             Padding(
               ...
               child: SizedBox(
                 ...
                 child: ElevatedButton(onPressed: (){},
                  child: Padding(
                    padding: const EdgeInsets.only(left: 20),
                    child: Row(children: [Icon(Icons.facebook,color: Colors.black,),Text("Log in with facebook",style: TextStyle(color: Colors.black),)],),
                  ),
                  style: ElevatedButton.styleFrom(
                    primary: Colors.white,
                     shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30))
             ...
             Padding(
               ...
               child: Text('Trouble Logging in?',style: TextStyle(color: Colors.white),),
             )
          ],
          )
